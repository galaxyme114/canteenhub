...
const Register = () => {
  ...
  const {
    register, errors, setError, clearErrors, handleSubmit, watch,
  } = useForm();
  ...
  const onSubmit = async (data) => {
    ...
    if (isObjEmpty(errors)) {
      ...
      data.role = 'school'; // group  // set the user role
      data.ability = [
        {
          action: 'manage',
          subject: 'all',
  ...
  return (
    <div>
      ...
      <div className="auth-registration container-fluid h-100">
        <Row className="h-100">
          <Col className="flexbox-container flex-column justify-content-start align-items-start p-5" lg="5" xl="4">
          ...
          <Col className="flexbox-container align-items-start flex-column bg-white px-5">

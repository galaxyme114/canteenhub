...
// constants
import statusOptions from '../../../../models/constants/userStatus';
...
const UsersList = () => {
  ...
  const [currentStatus, setCurrentStatus] = useState(store.params.status ? statusOptions.find(({ value }) => value === store.params.status) : { value: '', label: 'Status...' });
